...
public class Window {
    ...
    public Window(Minecraft minecraft, int width, int height, String title) {
        this.width = width;
        this.height = height;
        this.title = title;
    ...
    public void Create() throws LWJGLException { Create(true); }

    public void Create(boolean vsync) throws LWJGLException {
        if (!GLFW.glfwInit()) {
